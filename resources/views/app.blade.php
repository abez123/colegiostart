...
<head>
    ...
    <title>@section('title') Colegio Iberoamericano @show</title>
    @section('meta_keywords')
        <meta name="keywords" content="Escuela, Primaria, Secundaria, Preparatoria, Colegio"/>
    @show @section('meta_author')
        <meta name="author" content="Abel Zolorzano"/>
    @show @section('meta_description')
        <meta name="description"
              content="Sitio administrativo de >colegio Iberoamericano"/>
    @show
